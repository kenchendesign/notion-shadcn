...
export const personCropCircleBadgeExclamationPointIcon: LoadedIconFunction<"default"> =
	createIcon("personCropCircleBadgeExclamationPoint", iconDefinition, "default")
